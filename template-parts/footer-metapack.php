        ...
        <div class="mp-footer-v2__main">
            ...
            <div class="mp-footer-v2__col mp-footer-v2__col--contact">
                ...
                <div class="mp-footer-v2__social-row">
                    <a href="https://wa.me/<?php echo esc_attr(get_theme_mod('contact_whatsapp', '523313011647')); ?>" class="mp-footer-v2__social-icon" target="_blank" rel="noopener">
...
<!-- WHATSAPP FLOTANTE -->
<a href="https://wa.me/<?php echo esc_attr(get_theme_mod('contact_whatsapp', '523313011647')); ?>" class="mp-whatsapp-float" target="_blank" rel="noopener">
