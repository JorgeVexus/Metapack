        ...
        <div class="mp-footer-v2__main">
            ...
            <div class="mp-footer-v2__col mp-footer-v2__col--contact">
                ...
                <div class="mp-footer-v2__info">
                    ...
                    <div class="mp-footer-v2__info-group">
                        ...
                        <div class="mp-footer-v2__info-content">
                            ...
                            <p>Oficina: <a href="tel:<?php echo preg_replace('/[^0-9+]/', '', get_theme_mod('contact_phone_office', '33 3649 0281')); ?>"><?php echo esc_html(get_theme_mod('contact_phone_office', '33 3649 0281')); ?></a></p>
                            <p>Ventas: <a href="tel:<?php echo preg_replace('/[^0-9+]/', '', get_theme_mod('contact_phone_sales', '33 1301 1647')); ?>"><?php echo esc_html(get_theme_mod('contact_phone_sales', '33 1301 1647')); ?></a></p>
                        </div>
                    </div>
                    <!-- Email -->
                    <div class="mp-footer-v2__info-group">
                ...
                <div class="mp-footer-v2__social-row">
                    <a href="https://wa.me/<?php echo esc_attr(get_theme_mod('contact_whatsapp', '523313011647')); ?>" class="mp-footer-v2__social-icon" target="_blank" rel="noopener" aria-label="WhatsApp">
                    ...
                    <a href="<?php echo esc_url(get_theme_mod('social_instagram', '#')); ?>" class="mp-footer-v2__social-icon" target="_blank" rel="noopener" aria-label="Instagram">
                    ...
                    <a href="<?php echo esc_url(get_theme_mod('social_youtube', '#')); ?>" class="mp-footer-v2__social-icon" target="_blank" rel="noopener" aria-label="YouTube">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<!-- WHATSAPP FLOTANTE -->
<a href="https://wa.me/<?php echo esc_attr(get_theme_mod('contact_whatsapp', '523313011647')); ?>" class="mp-whatsapp-float" target="_blank" rel="noopener" aria-label="Contactar por WhatsApp">
