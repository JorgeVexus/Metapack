...
// =================================================
// RENDIMIENTO: HABILITAR LAZY LOADING NATIVO
// =================================================
add_filter('wp_lazy_loading_enabled', '__return_true');

// =================================================
// RENDIMIENTO: DESACTIVAR EMOJIS DE WORDPRESS
// =================================================
function metapack_disable_emojis() {
    ...
    add_filter('tiny_mce_plugins', 'metapack_disable_emojis_tinymce');
    add_filter('wp_resource_hints', 'metapack_disable_emojis_dns_prefetch', 10, 2);
}
add_action('init', 'metapack_disable_emojis');

function metapack_disable_emojis_tinymce($plugins) {
    if (is_array($plugins)) {
...
function metapack_disable_emojis_dns_prefetch($urls, $relation_type) {
